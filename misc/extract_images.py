...
class FileWindow(object):
    ...
    def __init__(self, infile: '_io.TextIOWrapper', window_size: int = 10):
        '''
    ...
    def __next__(self):
        if not self.window[self.__window_size] == None:
...
def extract_images_from_xml_dump(infile: '_io.TextIOWrapper', outfile: '_io.TextIOWrapper', neighboring_lines: int = 10):
    '''
